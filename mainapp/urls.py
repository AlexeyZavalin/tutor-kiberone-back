...
urlpatterns = [
    ...
    path('create-group/', views.CreateGroupView.as_view(),
         name='create-group'),
    path('update-group/<int:pk>/', views.UpdateGroupView.as_view(),
         name='update-group'),
    ...
    path('update-student/<int:pk>/', views.UpdateStudentView.as_view(),
         name='update-student'),
    ...
    path('kiberon-reg-delete/', views.KiberonRegDelete.as_view(),
         name='kiberon-reg-delete'),
    path('personal_area/', views.StudentPersonalArea.as_view(),
         name='student_personal_area'),
    path('my_group/', views.StudentGroup.as_view(),
         name='student_group')
