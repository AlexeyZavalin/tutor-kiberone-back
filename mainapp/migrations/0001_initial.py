# Generated by Django 3.2.3 on 2021-05-28 05:38
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('full_name', models.CharField(max_length=80, verbose_name='Фамилия Имя тьютора')),
                ('email', models.EmailField(max_length=50, unique=True, verbose_name='Email тьютора')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tutor', models.ForeignKey(default=None, on_delete=django.db.models.deletion.SET_DEFAULT, to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'verbose_name': 'Группа',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('achievement', models.CharField(choices=[('visit', 'Посещение урока'), ('eyes', 'Разминка глаз'), ('fastest', 'Быстрее всех завершил задание'), ('homework', 'За выполнение домашнего задания'), ('instagram', 'За пост в instagram'), ('social', 'За посты в соц. сети')], default=('visit', 'Посещение урока'), max_length=10, unique=True, verbose_name='Достижение')),
