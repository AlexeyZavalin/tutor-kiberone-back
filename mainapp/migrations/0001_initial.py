# Generated by Django 3.2.3 on 2021-06-06 23:10
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('times', models.TextField(default='', max_length=500, verbose_name='Времена уроков в формате чч:мм')),
                ('locations', models.TextField(default='', max_length=500, verbose_name='Локации')),
                ('kiberons', models.TextField(default='', max_length=500, verbose_name='Кибероны в формате Достижение - количество киберонов (int)')),
            ],
            options={
